...
export const ProductTable = pgTable("products",
    ...
    table => ({
        // index for fast lookup by clerkUserId
        // this is useful for fetching products created by a specific user
        // and for checking if a user has already created a product
        // this is not a unique index, as a user can create multiple products
...
// this product has the ability to be customized
...
// table for tracking how many times a product has been viewed
// this is useful for analytics and for showing the number of views on the product page
...
// country table and country group table used to store countries and their groups
...
// the procut can have discounts based on the country group
// this is useful for applying discounts to all products in a country group
...
// this is used to store the user's subscription details
// such as the tier, stripe subscription id, and stripe customer id
